...
define('ROOT', dirname(__FILE__)); //le nom du répertoire
...
$controllerclassname=ucfirst($controller).'Controller'; // ucfirst pour rentre le E majiscule
